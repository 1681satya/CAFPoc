...
@ManagedBean(name = "Task1Overview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "Task1Overview", beanType = BeanType.PORTLET)
public class Task1Overview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
